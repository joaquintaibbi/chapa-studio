...
import { MessageSquare, MapPin, Zap, ArrowUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-neutral-600 max-w-sm leading-relaxed font-semibold">
              Somos un estudio boutique de automatizaciones. Ayudamos a pymes, profesionales y comercios a simplificar sus procesos para que recuperen tiempo valioso.
            </p>
