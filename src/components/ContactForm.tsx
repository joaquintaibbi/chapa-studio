          ...
          <div className="space-y-8">
            ...
            <div className="pt-2 text-center">
              ...
              <div className="mt-4 text-center">
                <span className="text-xs text-neutral-500 font-semibold font-sans">
                  O escribinos por mail a{' '}
                  <a href="mailto:chapastudioIA@gmail.com" className="text-chapa-orange hover:underline font-bold">
