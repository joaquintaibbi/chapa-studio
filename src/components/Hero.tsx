        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <div>
                <span className="flex items-center gap-1.5 font-display text-2xl font-black text-chapa-black">
                  <span className="w-2 h-2 rounded-full bg-chapa-orange animate-pulse inline-block" />
                  100%
                </span>
              ...
              <div className="border-l border-neutral-200/80 pl-4">
                <span className="flex items-center gap-1.5 font-display text-2xl font-black text-chapa-black">
                  <span className="w-2 h-2 rounded-full bg-chapa-black inline-block" />
                  Al toque
                </span>
              ...
              <div className="border-l border-neutral-200/80 pl-4">
                <span className="flex items-center gap-1.5 font-display text-2xl font-black text-chapa-black">
                  <span className="w-2 h-2 rounded-full bg-chapa-orange inline-block" />
                  +80%
                </span>
                <span className="block text-[10px] text-neutral-500 font-mono uppercase tracking-wider font-bold">Tiempo de sobra</span>
              </div>
            </motion.div>
