...
export default function AestheticMarquee() {
  ...
  return (
    <div id="aesthetic-marquee-section" className="relative bg-neutral-950 border-y-4 border-neutral-900 py-3.5 sm:py-5 overflow-hidden z-20">
      ...
      {/* Decorative mechanical corner crosses for engineering aesthetic */}
      <div className="absolute top-1 left-2 text-[10px] text-chapa-orange/40 font-mono select-none">+[01]</div>
      <div className="absolute top-1 right-2 text-[10px] text-chapa-orange/40 font-mono select-none">[02]+</div>
      <div className="absolute bottom-1 left-2 text-[10px] text-chapa-orange/40 font-mono select-none">+[03]</div>
      <div className="absolute bottom-1 right-2 text-[10px] text-chapa-orange/40 font-mono select-none">[04]+</div>
